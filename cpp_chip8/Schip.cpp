...
void Schip::LD_HF_Vx(int x) {
	m_mnemomicFormat = "LD\tHF,V{0:X1}";
	m_i = HighFontOffset + (10 * m_v[x]);
}

void Schip::XDRW(int x, int y) {
	m_mnemomicFormat = "XDRW V{0:X1},V{1:X1}";
	draw(x, y, 16, 16);
}
